...
import com.sansec.httpclient.util.HttpClientUtil;
...
////                    System.out.println(material.getMessage());
...
//    KMSCoreClient kmsCoreClient = new KMSCoreClientImpl(config);
//    BaseRequestConfig baseRequestConfig = new BaseRequestConfig();
//    baseRequestConfig.setRestUrl("http://10.0.104.78:3333/kms/core/v4");
...
//    System.out.println(material);
    ...
    String s = HttpClientUtil.doPost("http://10.0.104.78:3333/kms/core/v4/keys/getmaterial", null);
//    Socket socket = new Socket();
//    socket.setKeepAlive(true);
//    socket.setSoTimeout(300000);
//    socket.connect(new InetSocketAddress("10.0.104.78", 3333));
...
//    System.out.println(read);
    ...
    public static KmsRestResponse<KeyDTO> getMaterial(GetMaterialRequest getKeyRequest) {
        String res = OkHttpClientUtils.doPost("http://10.0.104.78:3333/kms/core/v4/keys/getmaterial", JSON.toJSONString(getKeyRequest));
